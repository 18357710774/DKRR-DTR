% KRR-DTR with the selected parameters  (multi + joint case)
...
opt.algoparams(1) = 0.1129;         % KRR: the fisrt parameter is width of kernel, 
...
savefile = [cd '\SynResults\clinical_flexiblestagesNtr' num2str(n_train) ...
            '_' opt.algoname  '_markovmulti_mix' '_baseline.mat'];
