% DNN-DTR with the selected parameters  (single + separate case)
...
opt.algoparams.hidden_layers_number = 4;    % hidden_layers_number
opt.algoparams.hidden_neuron_number = 40;   % hidden_neuron_number
