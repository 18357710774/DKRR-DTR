% parameter selection step for krr (markov case)
...
% sigma_seq(sigma_seq>2) = [];
% sigma_seq(sigma_seq<0.1) = [];
...
%     lambda_seq(lambda_seq>10/n_train) = [];
    ...
    savefile = [cd '\SynResults\cancer_fixstagesNtr' num2str(n_train) ...
                '_' opt.algoname  '_markov_paraSel.mat'];
...
savefile = [cd '\SynResults\cancer_fixstagesNtrVary_' ...
            opt.algoname  '_markov_paraSel.mat'];
