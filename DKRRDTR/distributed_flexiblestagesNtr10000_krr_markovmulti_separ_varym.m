% DKRR-DTR with the selected parameters  (multi + separate case)
...
opt.algoparams(1) = 0.0785;         % KRR: the fisrt parameter is width of kernel, 
...
savefile = [cd '\SynResults\distributed_clinical_flexstageNtr' num2str(n_train) ...
            '_' opt.algoname  '_markovmulti_separ_varym_Usplit.mat'];
