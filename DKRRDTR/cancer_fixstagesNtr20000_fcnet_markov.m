% DNN-DTR with the selected parameters  (markov case)
...
MaxEpochs = 8000;                         % MaxEpochs — Maximum number of epochs: 30 (default) | positive integer
...
opt.algoparams.hidden_neuron_number = 60;    % hidden_neuron_number
