function [total_time_hat, time_cost, end_trial_hat, num_actions_hat, initial_wellness] = distributed_example_dynamics(vf, a, opt)
valgo = vf.qfunctions;
Nr = vf.info_split.Nr;
...
for i = 1:num_stages
    ...
    [pi_actions(:, i), time_cost_tmp] = distributed_qfunction_testing(valgo{i}, X, Nr);
