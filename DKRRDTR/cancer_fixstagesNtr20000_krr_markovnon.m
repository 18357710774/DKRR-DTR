% KRR-DTR with the selected parameters  (non-markov case)
...
opt.algoparams(1) = 1.6238;            % KRR: the fisrt parameter is width of kernel, 
opt.algoparams(2) = 9.7656e-4;         %      the second parameter is regularization

% %  select the optimal parameter when the number of training samples is 10000
% opt.algoparams(1) = 1.6238;            % KRR: the fisrt parameter is width of kernel, 
% opt.algoparams(2) = 0.002;         %      the second parameter is regularization
